...
(function (SereneUrun) {
    ...
    })(Administration = SereneUrun.Administration || (SereneUrun.Administration = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Administration;
    (function (Administration) {
...
(function (SereneUrun) {
    ...
    })(BasicSamples = SereneUrun.BasicSamples || (SereneUrun.BasicSamples = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneUrun.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SereneUrun.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneUrun.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SereneUrun) {
    ...
    })(Common = SereneUrun.Common || (SereneUrun.Common = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Common;
...
(function (SereneUrun) {
    ...
    })(Membership = SereneUrun.Membership || (SereneUrun.Membership = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Membership;
...
(function (SereneUrun) {
    ...
    })(Northwind = SereneUrun.Northwind || (SereneUrun.Northwind = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Northwind;
...
(function (SereneUrun) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SereneUrun.Northwind.Gender', 'SereneUrun.Northwind.Entities.Gender');
    })(Northwind = SereneUrun.Northwind || (SereneUrun.Northwind = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
...
(function (SereneUrun) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SereneUrun.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SereneUrun.Northwind || (SereneUrun.Northwind = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
...
(function (SereneUrun) {
    ...
    })(Authorization = SereneUrun.Authorization || (SereneUrun.Authorization = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Administration;
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneUrun.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneUrun.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneUrun.Common.ReportHelper.execute({
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneUrun.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneUrun.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneUrun.Northwind.OrderDialog();
                        ...
                        var chai = SereneUrun.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneUrun.Northwind.EmployeeRow.getLookup().items
        ...
        }(SereneUrun.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneUrun.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.OrderDialog));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SereneUrun.Northwind.CategoryService.Retrieve({
        ...
        }(SereneUrun.Northwind.CategoryDialog));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SereneUrun.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SereneUrun.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneUrun.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneUrun.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SereneUrun.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneUrun.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneUrun.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneUrun.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneUrun.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneUrun.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneUrun.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return SereneUrun.LanguageList.getValue();
            };
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.SupplierDialog));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SereneUrun.Northwind.SupplierGrid));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneUrun.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneUrun.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneUrun.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneUrun.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneUrun.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneUrun.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneUrun.Northwind.CustomerDialog));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.CustomerGrid));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneUrun.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SereneUrun.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneUrun.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SereneUrun.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SereneUrun.Northwind.OrderDetailDialog));
...
(function (SereneUrun) {
    ...
    (function (Northwind) {
        ...
        }(SereneUrun.Common.GridEditorBase));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Northwind.OrderDetailsEditor));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneUrun.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneUrun.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneUrun.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneUrun.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneUrun.BasicProgressDialog();
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneUrun.Common.BulkServiceAction));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneUrun.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneUrun.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneUrun.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneUrun.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneUrun.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneUrun.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneUrun.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SereneUrun) {
    ...
    SereneUrun.SelectableEntityGrid = SelectableEntityGrid;
})(SereneUrun || (SereneUrun = {}));
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneUrun.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneUrun.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneUrun.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneUrun.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SereneUrun.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneUrun.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneUrun.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneUrun.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneUrun.Northwind.ProductService.baseUrl; };
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneUrun.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneUrun.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneUrun.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SereneUrun.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SereneUrun) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneUrun.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneUrun.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneUrun.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SereneUrun) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneUrun.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneUrun.LanguageList || (SereneUrun.LanguageList = {}));
})(SereneUrun || (SereneUrun = {}));
...
(function (SereneUrun) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SereneUrun.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SereneUrun.ScriptInitialization || (SereneUrun.ScriptInitialization = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    ...
    SereneUrun.BasicProgressDialog = BasicProgressDialog;
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var DialogUtils;
    ...
    })(DialogUtils = SereneUrun.DialogUtils || (SereneUrun.DialogUtils = {}));
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Common;
...
(function (SereneUrun) {
    ...
    SereneUrun.StaticTextBlock = StaticTextBlock;
})(SereneUrun || (SereneUrun = {}));
var SereneUrun;
(function (SereneUrun) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneUrun.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=SereneUrun.Web.js.map